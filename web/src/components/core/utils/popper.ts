...
import type { Instance, OptionsGeneric, Modifier, VirtualElement } from "@popperjs/core"
...
>(initOptions?: PopperOptions<TModifier>): [ReferenceAction, ContentAction<TModifier>, () => Instance | null] {
